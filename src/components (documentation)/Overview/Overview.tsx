    ...
    <MainContainer>
      ...
      <SingleSection>
        <Introduction>
          ...
          <TextSpan>
            ...
            wide range of customizable options, it allows developers to quickly
            implement designs that match their specific needs, and with ease of
            use in mind, it can be used by developers of all skill levels. UIsed
            helps to reduce the time it takes to develop and maintain a project
            while providing a consistent and polished look and feel to the final
            product.
          </TextSpan>
        </Introduction>
        <Image
      ...
      <SingleSection>
        ...
        <SingleAdvantage>
          ...
          UIsed provides a wide range of pre-built components that can be easily
          integrated into your project, saving time and effort in the
          development process.
        </SingleAdvantage>
        <SingleAdvantage>
          ...
          ensure a consistent look and feel throughout your application, making
          it more polished and professional.
        </SingleAdvantage>
        <SingleAdvantage>
          <AdvantageBold>Customizability: </AdvantageBold>
          UIsed provides a wide range of options for customizing each component,
          allowing you to tailor them to your specific needs and design
          requirements.
        </SingleAdvantage>
        <SingleAdvantage>
        ...
        <SingleAdvantage>
          ...
          support, bug reports and fixing issues. This also means you will have
          access to a wealth of knowledge, troubleshooting and solutions to
          common problems when using the library.
        </SingleAdvantage>
        <Image
